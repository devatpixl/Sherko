...
export const script: Step[] = [
  ...
  { kind: "compose", ms: 1820, text: m1.kind === "text" ? m1.text : { no: "", en: "" }, item: m1 },
  { kind: "tick", ms: 210, id: "m1", to: "sent" },
  { kind: "tick", ms: 238, id: "m1", to: "delivered" },
  { kind: "tick", ms: 294, id: "m1", to: "read" },

  { kind: "form", ms: 546, patch: { kunde: B("Nordby Kafé AS", "Nordby Kafé AS") } },
  { kind: "typing", ms: 490 },
  { kind: "form", ms: 574, patch: { varer: B("Kavli mysost 500 g · 20 kartonger", "Kavli mysost 500 g · 20 cases") } },
  { kind: "form", ms: 490, patch: { levering: B("fredag 29. august", "Friday 29 August") } },
  { kind: "push", ms: 2100, item: m2 },

  { kind: "compose", ms: 910, text: m3.kind === "text" ? m3.text : { no: "", en: "" }, item: m3 },
  { kind: "tick", ms: 210, id: "m3", to: "sent" },
  { kind: "tick", ms: 280, id: "m3", to: "read" },
  { kind: "typing", ms: 560 },
  { kind: "form", ms: 630, patch: { ordre: B("#12048", "#12048"), status: PENDING } },
  { kind: "push", ms: 2030, item: m4 },

  /* — Act II: a photo of a handwritten whiteboard — */
  { kind: "attach", ms: 980, item: m5 },
  { kind: "form", ms: 350, patch: CLEAR },
  { kind: "tick", ms: 210, id: "m5", to: "sent" },
  { kind: "tick", ms: 266, id: "m5", to: "read" },
  { kind: "ocr", ms: 2240 },
  ...
  { kind: "tick", ms: 210, id: "m7", to: "sent" },
  { kind: "tick", ms: 266, id: "m7", to: "read" },
  { kind: "form", ms: 574, patch: { note: null, varer: B("6 varelinjer · alle funnet", "6 lines · all found") } },
  { kind: "typing", ms: 490 },
  { kind: "form", ms: 630, patch: { ordre: B("#12049", "#12049"), status: PENDING } },
  { kind: "push", ms: 2520, item: m8 },
